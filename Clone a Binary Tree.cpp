...
Node* clone_left_right(Node *root)
{
    if(root == NULL)
    {
        return NULL;
    ...
    mp[root]->left=clone_left_right(root->left);
    mp[root]->right=clone_left_right(root->right);
    return mp[root];
}

void clone_randoms(Node *root)
{
    if(root == NULL)
    {
        return;
    ...
    clone_randoms(root->left);
    clone_randoms(root->right);
}
...
class Solution{
  public:
    ...
    Node* cloneTree(Node* root)
    {
       ...
       Node *rootc=clone_left_right(root);
       clone_randoms(root);
       return rootc;
    }
};
